class State():
	def __init__(self, cannibalLeft, missionaryLeft, boat, cannibalRight, missionaryRight): #constructor method
...
def get_user_input():
    cannibalLeft = int(input("Enter the number of cannibals on the left side: "))
    missionaryLeft = int(input("Enter the number of missionaries on the left side: "))
    boat = input("Enter the boat location ('left' or 'right'): ").lower()
    cannibalRight = int(input("Enter the number of cannibals on the right side: "))
    missionaryRight = int(input("Enter the number of missionaries on the right side: "))

    return State(cannibalLeft, missionaryLeft, boat, cannibalRight, missionaryRight)
